...
#APP_ROUTE_PCRF = '/sltdevops/apiServices/autoprovision/pcrf'
...
APP_ROUTE_GETMOBILE = '/api/mobitel/reverse/mobileNumber/'

APP_ROUTE_TOKEN = '/sltdevops/apiServices/autoprovision/token'
